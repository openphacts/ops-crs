...
namespace Microsoft.Samples {
    ...
    public class SqlTableProfileProvider : ProfileProvider {
        ...
        private void GetProfileDataFromTable(SettingsPropertyCollection properties, SettingsPropertyValueCollection svc, string username, SqlConnection conn) {
            ...
            commandText.Append("' AND u.UserName = LOWER(@Username) AND t.user_guid = u.UserID");
        ...
        public override void SetPropertyValues(SettingsContext context, SettingsPropertyValueCollection collection) {
            ...
            try {
                ...
                sqlCommand.Append(" WHERE user_guid = @UserId) ");
                ...
                columnStr.Append(",last_updated ");
                valueStr.Append(",@LastUpdatedDate");
                setStr.Append(",last_updated=@LastUpdatedDate");
                cmd.Parameters.AddWithValue("@LastUpdatedDate", DateTime.UtcNow);

                sqlCommand.Append("BEGIN UPDATE ").Append(_table).Append(" SET ").Append(setStr.ToString());
                sqlCommand.Append(" WHERE user_guid = '").Append(userId).Append("'");

                sqlCommand.Append("END ELSE BEGIN INSERT ").Append(_table).Append(" (user_guid").Append(columnStr.ToString());
